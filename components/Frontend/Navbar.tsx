    ...
    <header className="fixed top-0 bg-white border-b border-gray-400/30 w-full z-50">
      ...
      aria-label="Global">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" className="text-sm/6 font-semibold leading-6 text-gray-800">
            Features
          </a>
          <a href="#" className="text-sm/6 font-semibold leading-6 text-gray-800">
            Marketplace
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-200">
              <div className="space-y-2 py-6">
                ...
                <a
                  href="#"
                  className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-950 hover:bg-gray-50"
                >
                  Features
                </a>
                <a
